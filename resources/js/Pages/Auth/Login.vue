        ...
        <div class="flex items-center justify-center w-full p-6 bg-white lg:w-1/2">
            <div class="w-full max-w-md">
                ...
                <AuthenticationCard class="!bg-transparent !shadow-none !p-0">
                    ...
                    <h1 class="text-3xl font-bold text-center text-[#3198E8] mb-8">Login</h1>
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="relative">
                                ...
                                <TextInput id="password" v-model="form.password" type="password"
                                    class="block w-full pl-10 mt-1" required autocomplete="current-password"
                        ...
                        <div class="flex justify-end text-sm">
                            <Link v-if="canResetPassword" :href="route('password.request')"
                                class="font-medium text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3198E8]">
                            Lupa password?
                            </Link>
                        </div>
                    ...
                    <div class="mt-8 text-sm text-center text-gray-600">
                        ...
                        <Link :href="route('register')"
                            class="text-[#3198E8] hover:text-[#2a7bbf] font-semibold underline">Daftar</Link>
                    </div>
                </AuthenticationCard>
            </div>
        </div>
